...
class AppliancesOperations(object):
    ...
    def get_operation_status(
            self, resource_group_name, location, operation_id, custom_headers=None, raw=False, **operation_config):
        """Gets status of an appliance operation.

        :param resource_group_name: The name of the resource group. The name
         is case insensitive.
        :type resource_group_name: str
        :param location: The appliance location.
        :type location: str
        :param operation_id: The appliance operation Id.
        ...
        """
        # Construct URL
        url = '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Solutions/locations/{location}/operationStatuses/{operationId}'
